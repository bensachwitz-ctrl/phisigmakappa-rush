...
export function renderPostJobModal(ctx: DemoContext) {
  ...
  return (
                <div className="fixed inset-0 z-50 flex flex-col justify-end bg-slate-950/75 text-left backdrop-blur-sm lg:absolute" onClick={() => { setShowPostJobModal(false); resetJobForm(); setPostJobError(null); }}>
