...
import {
  ...
  Banknote, Wallet, ScrollText, Rocket, Landmark, Network, BookUser, CreditCard, MessagesSquare, CalendarRange, Crown, Trophy,
} from "lucide-react";
...
const ITEMS: NavItem[] = [
  ...
  { href: "/admin/chat", label: "Chat", icon: MessagesSquare, adminOnly: false, group: "more" },
