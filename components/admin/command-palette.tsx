...
export function CommandPalette({
  ...
  const commands: Cmd[] = React.useMemo(() => {
    const base: Cmd[] = [
      ...
      { id: "nav-family", group: "Navigate", icon: IconFamilyTree, label: "Big / Little Family Tree", href: "/admin/family", synonyms: ["big", "little", "lineage", "family", "pledge class", "littles", "bigs", "tree"], domain: "brothers" },
      ...
      { id: "act-exports", group: "Actions", icon: IconExports, label: "HQ Exports", href: "/admin/exports", synonyms: ["download", "csv", "report", "headquarters", "nationals", "data"], domain: "payments" },
