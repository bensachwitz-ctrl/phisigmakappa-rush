...
const defaultIdentity: ChapterIdentity = {
  ...
  rushEmail: "rush@phisig-usc.com",
  advisorEmail: "advisor@phisig-usc.com",
  schoolFslUrl: "https://sc.edu/about/offices_and_divisions/student_life/our_initiatives/fraternity_and_sorority_life/index.php",
